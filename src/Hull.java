...
class Hull {
  ...
  class bcHandler extends DefaultHandler {
    ...
    public void startElement(String ns, String n, String qn, Attributes a) throws SAXException {
      itag++;
      tags[itag] = qn;
      ...
      if (qn.compareTo("hull") == 0) {
        ...
        sbRigX = new StringBuffer();
      } else if (qn.compareTo("rigZ") == 0) {
        sbRigY = new StringBuffer();
      }
        ...
        iStn++;
        sbStnX = new StringBuffer();
      } else if (qn.compareTo("water") == 0) {
        sbWater = new StringBuffer();
      } else if (qn.compareTo("lstem") == 0) {
        sbLStem = new StringBuffer();
      } else if (qn.compareTo("rstem") == 0) {
        sbRStem = new StringBuffer();
      } else if (qn.compareTo("units") == 0) {
        sbUnits = new StringBuffer();
    ...
    public void characters(char buf[], int offset, int len) {
      ...
      if (tags[itag].compareTo("stnX") == 0) {
        sbStnX.append(s);
      } else if (tags[itag].compareTo("baseline") == 0) {
        sbBase.append(s);
      } else if (tags[itag].compareTo("water") == 0) {
        sbWater.append(s);
      } else if (tags[itag].compareTo("lstem") == 0) {
        sbLStem.append(s);
      } else if (tags[itag].compareTo("rstem") == 0) {
        sbRStem.append(s);
      } else if (tags[itag].compareTo("units") == 0) {
        sbUnits.append(s);
      } else if (tags[itag].compareTo("designer") == 0) {
        sbNA.append(s);
      } else if (tags[itag].compareTo("designname") == 0) {
        sbDName.append(s);
      } else if (tags[itag].compareTo("linename") == 0) {
        sbLName.append(s);
      }

      else if (tags[itag].compareTo("valX") == 0) {
        sbX.append(s);
      } else if (tags[itag].compareTo("valY") == 0) {
        sbY.append(s);
      } else if (tags[itag].compareTo("valZ") == 0) {
        sbZ.append(s);
      } else if (tags[itag].compareTo("ptValid") == 0) {
        sbV.append(s);
      }


      else if (tags[itag].compareTo("wgtLbl") == 0) {
        sbWL.append(s.trim());
      } else if (tags[itag].compareTo("wgtWgt") == 0) {
        sbWW.append(s.trim());
      } else if (tags[itag].compareTo("wgtX") == 0) {
        sbWX.append(s.trim());
      } else if (tags[itag].compareTo("wgtY") == 0) {
        sbWY.append(s.trim());
      } else if (tags[itag].compareTo("wgtZ") == 0) {
        sbWZ.append(s.trim());
      }

      else if (tags[itag].compareTo("rigX") == 0) {
        sbRigX.append(s);
      } else if (tags[itag].compareTo("rigZ") == 0) {
        sbRigY.append(s);
      } else if (tags[itag].compareTo("foilX") == 0) {
        sbFoilX.append(s);
      } else if (tags[itag].compareTo("foilZ") == 0) {
        sbFoilY.append(s);
      }

    }

    public void endElement(String ns, String n, String qn) throws SAXException {
      String ts;
      itag--;
      if (qn.compareTo("valX") == 0) {
        x = Double.parseDouble(sbX.toString());
      } else if (qn.compareTo("valY") == 0) {
        y = Double.parseDouble(sbY.toString());
      } else if (qn.compareTo("valZ") == 0) {
        z = Double.parseDouble(sbZ.toString());
      } else if (qn.compareTo("ptValid") == 0) {
        ts = sbV.toString();
        ...
        Stations[iStn] = Double.parseDouble(sbStnX.toString());
      } else if (qn.compareTo("baseline") == 0) {
        base = Double.parseDouble(sbBase.toString());
      } else if (qn.compareTo("water") == 0) {
        units.WATER = Integer.parseInt(sbWater.toString());
      }
        ...
        units.UNITS = Integer.parseInt(sbUnits.toString());
      } else if (qn.compareTo("designer") == 0) {
        designer = sbNA.toString();
      } else if (qn.compareTo("designname") == 0) {
        boatname = sbDName.toString();
      } else if (qn.compareTo("linename") == 0) {
        linename = sbLName.toString();
      }

      else if (qn.compareTo("wgtLbl") == 0) {
        wgtLbl[iWgt] = sbWL.toString();
      } else if (qn.compareTo("wgtWgt") == 0) {
        wgtWgt[iWgt] = Double.parseDouble(sbWW.toString());
      } else if (qn.compareTo("wgtX") == 0) {
        wgtX[iWgt] = Double.parseDouble(sbWX.toString());
      } else if (qn.compareTo("wgtY") == 0) {
        wgtY[iWgt] = Double.parseDouble(sbWY.toString());
      } else if (qn.compareTo("wgtZ") == 0) {
        wgtZ[iWgt] = Double.parseDouble(sbWZ.toString());
      }
  ...
  public void getHulls(File hullfile) {
    ...
    try {
      ...
      n = filename.indexOf('.');
      if (n > 0)
        boatname = filename.substring(0, n);
      else
        boatname = filename;
    ...
    try {
      ...
      while (l.hasNext()) {
        ...
        for (int i = 0; i < Stations.length; i++) {
          ...
          if (ln.valid(i))
            emitln(w, "         <ptValid>true</ptValid>");
          else
            emitln(w, "         <ptValid>false</ptValid>");
          emitln(w, "      </point>");
        }
        emitln(w, "   </line>");
      }
      ...
      if (rig.valid) {
        ...
        for (is = 0; is < 3; is++) {
          if (is == 0) {
            sl = rig.main;
            emitln(w, "   <sail type='main' use='" + sl.use + "' head='" + sl.useGaff + "' roach='"
                + sl.useRoach + "'>");
          } else if (is == 1) {
            sl = rig.jib;
            emitln(w, "   <sail type='jib' use='" + sl.use + "' head='" + sl.useGaff + "' roach='"
                + sl.useRoach + "'>");
          } else {
            sl = rig.mizzen;
            emitln(w, "   <sail type='mizzen' use='" + sl.use + "' head='" + sl.useGaff
                + "' roach='" + sl.useRoach + "'>");
          }
  ...
  public void setLWL() {
    ...
    if (y > 0) {
      ...
      if (i <= 0)
        lwlRight = Stations[Stations.length - 1];
      else {
        double xl, xr;
        xl = Stations[i];
        xr = Stations[i + 1];
  ...
  public void calcDisp() {
    ...
    for (int i = 0; i <= NDIV; i++) {
      ...
      if (i > 0)
        hVals[DISP] = hVals[DISP] + dx * 0.5 * (vDisp[SAREA][i] + vDisp[SAREA][i - 1]);
    }
    if (hVals[SAREA] > 0) {
...
class Rig implements Cloneable {
  ...
  public double getMaxX() {
    double x = 0;
    if (main.use)
      x = Math.max(x, main.getMaxX());
    if (jib.use)
      x = Math.max(x, jib.getMaxX());
    if (mizzen.use)
      x = Math.max(x, mizzen.getMaxX());
    return x;
  }
  ...
  public double getMaxY() {
    double x = 0;
    if (main.use)
      x = Math.max(x, main.getMaxY());
    if (jib.use)
      x = Math.max(x, jib.getMaxY());
    if (mizzen.use)
      x = Math.max(x, mizzen.getMaxY());
    return x;
  }
  ...
  public double getMinX() {
    double x = 1000000;
    if (main.use)
      x = Math.min(x, main.getMinX());
    if (jib.use)
      x = Math.min(x, jib.getMinX());
    if (mizzen.use)
      x = Math.min(x, mizzen.getMinX());
    return x;
  }
  ...
  public double getMinY() {
    double x = 1000000;
    if (main.use)
      x = Math.min(x, main.getMinY());
    if (jib.use)
      x = Math.min(x, jib.getMinY());
    if (mizzen.use)
      x = Math.min(x, mizzen.getMinY());
    return x;
  }
  ...
  public double getAreaX() {
    double x = 0;
    if (main.use)
      x = x + main.getArea() * main.getAreaX();
    if (jib.use)
      x = x + jib.getArea() * jib.getAreaX();
    if (mizzen.use)
      x = x + mizzen.getArea() * mizzen.getAreaX();
    double a = getArea();
    if (a > 0)
      x = x / a;
    return x;
  ...
  public double getAreaY() {
    double x = 0;
    if (main.use)
      x = x + main.getArea() * main.getAreaY();
    if (jib.use)
      x = x + jib.getArea() * jib.getAreaY();
    if (mizzen.use)
      x = x + mizzen.getArea() * mizzen.getAreaY();
    double a = getArea();
    if (a > 0)
      x = x / a;
    return x;
...
class Sail implements Cloneable {
  ...
  public void setParamX(int i, double x) {
    p[0][i] = x;
  }

  public void setParamY(int i, double y) {
    p[1][i] = y;
  }

  public double getParamX(int i) {
    return p[0][i];
  }

  public double getParamY(int i) {
    return p[1][i];
  }
  ...
  public void setUseGaff(boolean b) {
    useGaff = b;
    changed = true;
  }

  public void setUseRoach(boolean b) {
    useRoach = b;
    changed = true;
  }
  ...
  public void setLuffLen(double x) {
    p[0][1] = x;
    changed = true;
  }

  public void setLuffAng(double x) {
    p[1][1] = x;
    changed = true;
  }

  public void setBoomLen(double x) {
    p[0][2] = x;
    changed = true;
  }

  public void setBoomAng(double x) {
    p[1][2] = x;
    changed = true;
  }

  public void setGaffLen(double x) {
    p[0][3] = x;
    changed = true;
  }

  public void setGaffAng(double x) {
    p[1][3] = x;
    changed = true;
  }

  public void setRoachMax(double x) {
    p[0][4] = x;
    changed = true;
  }

  public void setRoachPct(double x) {
    p[1][4] = x;
    changed = true;
  }
  ...
  public double getVal(int j, int i) {
    if (changed)
      setSail();
    return c[j][i];
  }
  ...
  public void setSail() {
    ...
    if (useGaff) {
      c[0][PEAK] =
          c[0][THROAT] + dir * p[0][GAFF] * Math.cos(Math.toRadians(p[1][GAFF] - p[1][LUFF]));
...
class Rudder implements Cloneable {
  ...
  public double getMaxX() {
    double x = 0;
    if (rudder.use)
      x = Math.max(x, rudder.getMaxX());
    if (skeg.use)
      x = Math.max(x, skeg.getMaxX());
    return x;
  }
  ...
  public double getMaxY() {
    double x = 0;
    if (rudder.use)
      x = Math.max(x, rudder.getMaxY());
    if (skeg.use)
      x = Math.max(x, skeg.getMaxY());
    return x;
  }
  ...
  public double getMinX() {
    double x = 1000000;
    if (rudder.use)
      x = Math.min(x, rudder.getMinX());
    if (skeg.use)
      x = Math.min(x, skeg.getMinX());
    return x;
  }
  ...
  public double getMinY() {
    double x = 1000000;
    if (rudder.use)
      x = Math.min(x, rudder.getMinY());
    if (skeg.use)
      x = Math.min(x, skeg.getMinY());
    return x;
  }
  ...
  public double getAreaX() {
    double x = 0;
    if (rudder.use)
      x = x + rudder.getArea() * rudder.getAreaX();
    if (skeg.use)
      x = x + skeg.getArea() * skeg.getAreaX();
    double a = getArea();
    if (a > 0)
      x = x / a;
    return x;
  ...
  public double getAreaY() {
    double x = 0;
    if (rudder.use)
      x = x + rudder.getArea() * rudder.getAreaY();
    if (skeg.use)
      x = x + skeg.getArea() * skeg.getAreaY();
    double a = getArea();
    if (a > 0)
      x = x / a;
    return x;
...
class Centerboard implements Cloneable {
  ...
  public double getAreaX() {
    double x = 0;
    if (board.use)
      x = x + board.getArea() * board.getAreaX();
    double a = getArea();
    if (a > 0)
      x = x / a;
    return x;
  ...
  public double getAreaY() {
    double x = 0;
    if (board.use)
      x = x + board.getArea() * board.getAreaY();
    double a = getArea();
    if (a > 0)
      x = x / a;
    return x;
  ...
  public void setPivotZ(double x) {
    pivot.z = x;
    changed = true;
  }

  public void setPivotAngle(double x) {
    angle = x;
    changed = true;
  }
  ...
  public void setRX(int i, double x) {
    rCB[0][i] = x;
    changed = true;
  }

  public void setRZ(int i, double x) {
    rCB[1][i] = x;
    changed = true;
  }
...
class rscFoil implements Cloneable {
  ...
  public void setWetPts(XZCompare xzComp) {
    sp = new TreeSet(xzComp);
  }

  public void addWetPt(Object p) {
    sp.add(p);
  }
  ...
  public void setFoil() {
    ...
    for (int i = 0; i < 4; i++)
      al.add(new Point(p[0][i], 0, p[1][i]));
...
class bcUnits {
  ...
  public double Vol2Wgt() {
    return v2w[WATER][UNITS];
  }

  public double Vol2Ton() {
    double r;
    if (UNITS <= 1)
      r = (v2w[WATER][UNITS] / 2240.0);
    else
      r = (v2w[WATER][UNITS] / 1000.0);
    return r;
  }
...
class hLine {
  ...
  public double max(String D) {
    ...
    for (i = 0; i < hPoints.length; i++) {
      if (hPoints[i].valid) {
        if (0 == D.compareTo("X"))
          t_max = Math.max(t_max, hPoints[i].x);
        if (0 == D.compareTo("Y"))
          t_max = Math.max(t_max, hPoints[i].y);
        if (0 == D.compareTo("Z"))
          t_max = Math.max(t_max, hPoints[i].z);
      }
    }
    return t_max;
  } // end max
  ...
  public double min(String D) {
    ...
    for (i = 0; i < hPoints.length; i++) {
      if (hPoints[i].valid) {
        if (0 == D.compareTo("X"))
          t_min = Math.min(t_min, hPoints[i].x);
        if (0 == D.compareTo("Y"))
          t_min = Math.min(t_min, hPoints[i].y);
        if (0 == D.compareTo("Z"))
          t_min = Math.min(t_min, hPoints[i].z);
      }
    }
    return t_min;
  } // end min
