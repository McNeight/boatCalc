...
public boatCalc() {
   ...
   protected void paintComponent(Graphics g) {
     ...
     double rx = (mx - 100.0)/(hull.rig.getMaxX() - hull.rig.getMinX());
     double ry = (my - 50.0)/(hull.rig.getMaxY() - hull.rig.getMinY());
     double r = Math.min(rx,ry);
