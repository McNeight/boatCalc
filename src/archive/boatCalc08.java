...
public boatCalc() {
   ...
   protected void paintComponent(Graphics g) {
    super.paintComponent(g);
     ...
     g.drawString(Double.toString(r),20,40);
          // draw waterline
          iu = xb + (int) (r * (hull.gx_min - hull.gx_min));
   ...
   public rdrData(int x, int y) {
      ...
      pInc.setLayout(new GridLayout(0,6));
      ...
      rbScale = new JRadioButton(" Scale");
      bgInc.add(rbScale);
      pInc.add(rbScale);
...
//   add(new Box.Filler(new Dimension(20,20),new Dimension(20,20),new Dimension(20,20)));
 ...
 //  add(new Box.Filler(new Dimension(20,20),new Dimension(20,20),new Dimension(20,20)));
   ...
   public pnlAbout(){
      ...
      lbl.setHorizontalAlignment(SwingConstants.CENTER);
      add(lbl);
      lbl = new JLabel ("Version 0.2b - 01/30/2004");
      lbl.setFont(wpFont);
      lbl.setHorizontalAlignment(SwingConstants.CENTER);
      add(lbl);
   }
